...
ln -s /opt/quepasa-source/helpers/quepasa-syslog.conf /etc/rsyslog.d/40-quepasa.conf

echo UPDATING LOGROTATE
ln -s /opt/quepasa-source/helpers/quepasa.logrotate.d /etc/logrotate.d/quepasa
...
ln -s /opt/quepasa-source/helpers/quepasa.service /etc/systemd/system/quepasa.service
...
ln -s /usr/lib/go/bin/go /usr/local/go/bin/go
